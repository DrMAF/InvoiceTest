...
namespace DAL
{
    ...
    {
        public static IQueryable<T> WithIncludes<T>(this IQueryable<T> Entities, List<string> includeProperties)where T : BaseEntity
        {
        ...
        public static IQueryable<T> UserWithIncludes<T>(this IQueryable<T> Entities, List<string> includeProperties) where T : User
        {
            if (includeProperties != null && includeProperties.Count > 0)
            {
                foreach (string include in includeProperties)
            ...
            try
            {
                ...
                foreach (DynamicOrdering o in orderings)
                {
                    queryExpr = Expression.Call(
                        ...
                        new Type[] { source.ElementType, (o.Selector != null ? o.Selector.Type : null) },
    ...
    internal class ClassFactory
    {
        ...
        private ClassFactory()
        {
            ...
            //AssemblyBuilder assembly =  AppDomain.CurrentDomain.(name, AssemblyBuilderAccess.Run);
